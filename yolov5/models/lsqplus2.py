...
class QuantConv2dPlus2(nn.Conv2d):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        super(QuantConv2dPlus2, self).__init__(
            in_channels,
            out_channels,
            kernel_size,
            stride,
    ...
    def forward(self, input):
        if self.activation_quantizer.quantize and self.train_batch == 0:
            ...
            # self.activation_quantizer.batch_init = 1500 // self.train_batch + 1
            # self.weight_quantizer.batch_init = 1500 // self.train_batch + 1
